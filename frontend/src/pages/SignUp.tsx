...
import { Award, Mail, Lock, User, ArrowRight, Loader2, CheckCircle } from 'lucide-react';
...
const SignUp = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Instead of login, show verification message
      toast({
        ...
        <div className="w-full max-w-md mx-auto px-4">
          <div className="bg-card border border-border rounded-2xl p-8 shadow-lg animate-fade-up">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">Start creating beautiful certificates today</p>
            </div>
